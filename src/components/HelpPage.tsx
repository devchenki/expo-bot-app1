        ...
        <CardContent className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">support@expobot.ru</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="rounded-md bg-primary/10 p-2">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">+7 (495) 123-45-67</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="rounded-md bg-primary/10 p-2">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">@expobot_support</p>
            </div>
          </div>
        </CardContent>
      </Card>
